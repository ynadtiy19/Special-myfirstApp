...
class StringsFr extends Strings {
  ...
  String get aboutToCancelChangesDescription =>
      'Vous êtes sur le point de supprimer toutes les modifications apportées à ce Todo.';
  ...
  String get aboutToCancelFeedbackDescription =>
      'Vous êtes sur le point de rejeter vos commentaires. Cela ne peut être annulé.';

  @override
  String get aboutToDeleteCompleted =>
      'Vous êtes sur le point de supprimer toutes les tâches terminées. Cette action est permanente et ne peut pas être annulée.';
  ...
  String get additionalFeaturesDescription =>
      'Des fonctionnalités qui rendent le Doable plus puissant';
  ...
  String get alignTodoCheckDescription =>
      'Afficher la coche Todo sur la droite';
  ...
  String get syncAndBackupDescription =>
      'Sauvegardez et synchronisez vos Todos';
  ...
  String get chooseFeedbackExtrasTitle =>
      'Quelles informations supplémentaires voulez vous inclure ?';
  ...
  String get generalDescription =>
      'Modifier le comportement général de l\'application';
  ...
  String get useBottomSheetMenuDescription =>
      'Utiliser une feuille de fond au lieu d\'une liste déroulante comme menu';
  ...
  String get contributorDescription =>
      'Les personnes qui ont aidé Doable à devenir ce qu\'elle est';
