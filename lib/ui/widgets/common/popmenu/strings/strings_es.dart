...
class StringsEs extends Strings {
  ...
  @override
  String get aboutOSInfo => 'Código fuente: [codeberg/flutter-doable](https://www.codeberg.org/florian-obernberger/flutter-doable)\nPolítica de privacidad: [codeberg/flutter-doable/privacy](https://codeberg.org/florian-obernberger/flutter-doable/src/branch/main/PRIVACY.md)\nRepositorio F-Droid: [codeberg/fdroid-repo](https://codeberg.org/florian-obernberger/fdroid-repo)\nMastodon: [@doable@floss.social](https://floss.social/@doable)';

  @override
  String get aboutToCancelChanges => '¿Deshacer los cambios?';

  @override
  String get aboutToCancelChangesDescription => 'Vas a deshacer todos los cambios realizados en esta tarea.';

  @override
  String get aboutToCancelFeedback => '¿Cancelar comentario?';

  @override
  String get aboutToCancelFeedbackDescription => 'Vas a cancelar tu comentario. No habrá vuelta atrás.';

  @override
  String get aboutToDeleteCompleted => 'Estás a punto de borrar todas tus tareas completadas. Esta acción es permanente y no se puede deshacer.';
  ...
  @override
  String get additionalFeaturesDescription => 'Características que hacen a Doable más completo';

  @override
  String get alignTodoCheck => 'Casilla a la derecha';

  @override
  String get alignTodoCheckDescription => 'Mostrar la casilla de la tarea a la derecha';
  ...
  @override
  String get chooseFeedbackExtrasDescription => 'Recomiendo incluir todos los apartados siguientes, dado que me ayudará a solucionar tu problema. No incluyen información personal.';

  @override
  String get chooseFeedbackExtrasTitle => '¿Qué información adicional quieres incluir?';
  ...
  @override
  String get customAccentPickerDescription => 'Escoge un color de acento personalizado para el tema de la app';

  @override
  String get darkMode => 'Modo oscuro';

  @override
  String get deleteCompletedAfter => 'Eliminar automáticamente tareas completadas';
  ...
  @override
  String get dynamicColorsDescription => 'Usa los colores del sistema (Android 12 en adelante)';
  ...
  @override
  String get feedbackDescriptionHelp => 'Una explicación más detallada de qué falló y cómo ocurrió.';

  @override
  String get feedbackHeader => 'Por favor, rellena los campos para ayudarme a entender qué ha fallado.';
  ...
  @override
  String get generalDescription => 'Cambiar el comportamiento general de la app';
  ...
  @override
  String get highlightOverdueDescription => 'Destacar tareas con retraso igual que las tareas con estrella';

  @override
  String get highlightToday => 'Destacar hoy';

  @override
  String get highlightTodayDescription => 'Destacar las tareas para hoy como las tareas con estrella';

  @override
  String get importLocalBackupError => 'No se ha podido importar el archivo. ¿Está seguro de que fue generado por Doable?';
  ...
  @override
  String get introDoubleTapDescription => 'Puedes pulsar dos veces en tareas con una descripción para expandirlas. Cuando se expanden, se muestra la descripción completa y puedes pulsar enlaces, etc.\n\n¡Puedes probar con este ejemplo de aquí!';

  @override
  String get introDoubleTapTodoDescription => '¡La tarta es una mentira!\n\nDescubre más aquí:\nhttps://theportalwiki.com/wiki/Cake';
  ...
  @override
  String get introLinksDescription => 'Cuando añades enlaces, números de teléfono o correos a una descripción, se destacan automáticamente y puedes interactuar con ellos.';

  @override
  String get introNextcloud => 'Nextcloud';

  @override
  String get introNextcloudDescription => 'También puedes sincronizar tus tareas con una instancia de Nextcloud. Si quieres, ¡puedes iniciar sesión aquí mismo!';

  @override
  String get introStar => 'Estrellas';

  @override
  String get introStarDescription => 'Añade una estrella a una tarea para\nque destaque entre las demás.\n\n¡Toca la estrella de debajo y pruébalo!';

  @override
  String get introTodos => 'Tareas';

  @override
  String get introTodosDescription => 'Cuando creas una nueva tarea puedes añadir varias cosas. Por ejemplo, puedes añadir una fecha para la tarea o marcarla con una estrella para hacer que destaque. Además, puedes añadir una descripción con enlaces u otra información relacionada con la tarea.';

  @override
  String get introWelcome => '¡Te damos la bienvenida a Doable!';

  @override
  String get introWelcomeDescription => 'La aplicación de tareas sencilla con un diseño \nmoderno e integración con Nextcloud.';
  ...
  @override
  String get ncLogOutMessage => 'Cuando te desconectas, tus credenciales se borran. Aún así, el archivo guardado en tu Nextcloud se mantendrá.';
  ...
  @override
  String get showCompletedTodosDescription => 'Muestra las tareas completadas en la lista';
  ...
  @override
  String get sortNewestFirstDescription => 'Las fechas recientes se muestran arriba';
  ...
  @override
  String get syncDirectoryDoesNotExist => 'El directorio especificado no existe.';
  ...
  @override
  String get syncNotNcServer => 'No se pudo encontrar un servidor de Nextcloud en esta dirección.';
  ...
  @override
  String get syncWrongUserOrPassword => 'El usuario o contraseña son incorrectos.';
  ...
  @override
  String get todoSearchDescription => 'Añade un botón de búsqueda a tu lista de tareas, permitiendo buscar entre ellas.';
  ...
  @override
  String get treatTodayAsIsImportantDescription => 'Si está activado, las tareas para hoy serán tratadas como si tuviesen una estrella';

  @override
  String get trimTodoTexts => 'Cortar textos de las tareas';

  @override
  String get trimTodoTextsDescription => 'Si está activo, recorta los espacios en blanco de títulos y descripciones de las tareas';

  @override
  String get trueBlackMode => 'Modo oscuro real';

  @override
  String get trueBlackModeDescription => 'Vuelve el fondo negro, especialmente útil para pantallas oled';
  ...
  @override
  String get useCustomTabsDescription => 'Usa un navegador interno de la app para abrir enlaces';
  ...
  @override
  String get routingError => '¡Uy! Parece que algo ha salido mal y has acabado en una página que, bueno, no existe. ¡Lo siento mucho!';
  ...
  @override
  String get introExtensionsDescription => 'Las extensiones te permiten ampliar las características de Doable. Te dan el poder de escoger específicamente cómo quieres usar Doable. Si quieres mirar todas las extensiones disponibles, ¡toca en el botón de debajo!';
  ...
  @override
  String get useBottomSheetMenuDescription => 'Usar un menú en la parte inferior en vez de un desplegable';

  @override
  String get contributors => 'Colaboradores';

  @override
  String get contributorDescription => 'Personas que han ayudado a Doable a ser lo que es';
  ...
  @override
  String get webdavLogOutMessage => 'Cuando cierras sesión tus credenciales se borran. Aun así, el archivo guardado permanece.';
  ...
  @override
  String get listsDescription => 'Crea listas y ordena tus tareas con ellas. Puedes crear una cantidad ilimitada de listas, accesibles a través del menú lateral en la pantalla principal.';
  ...
  @override
  String get fontDescription => 'Pulsación larga para mostrar los nombres de las fuentes';

  @override
  String get popUpAnimationOverSlideAnimation => 'Transición de página antigua';

  @override
  String get popUpAnimationOverSlideAnimationDescription => 'Usa la el antiguo estilo de transición de página';
  ...
  @override
  String get restartRequiredForSetting => 'Es necesario reiniciar la app para aplicar este ajuste.';
  ...
  @override
  String get doableBrandingText => 'Compartido desde Doable, la app sencilla, moderna y fácil de usar.\nPuedes obtener Doable aquí: https://codeberg.org/florian-obernberger/flutter-doable';

  @override
  String get chooseTodoShareType => 'Selecciona cómo quieres compartir tus tareas';
  ...
  @override
  String get reduceMotionDescription => 'Reduce el movimiento de las animaciones';
  ...
  @override
  String get contributeWantYourNameHereDescription => '¡Contribuye directamente con Doable o ayuda en la traducción!';

  @override
  String get onlySymbolInDetailViewFab => 'Icono en vez de texto';

  @override
  String get onlySymbolInDetailViewFabDescription => 'Utilizar un icono en lugar de texto en la vista detallada de tarea';
  ...
  @override
  String get sharedTextAsTitleDescription => 'Usar el texto compartido a Doable como el título de una nueva tarea en vez de como descripción';
  ...
  @override
  String get syncTooManyTimeOuts => 'El servidor no ha respondido varias veces. La sincronización se desactivará hasta que se reinicie la app.';
  ...
  @override
  String get aboutToClearAllLogs => 'Estás a punto de borrar todos los registros, haciéndolos inaccesibles para comentarios y resolución de problemas. Esta acción es permanente y no se puede deshacer.';
  ...
  @override
  String get createSummaryForBugReportDetails => 'Crea un informe que contiene información del sistema, la configuración de Doable y todos los registros. Esto puede ser útil para los informes de errores y ayuda a solucionar un problema.';

  @override
  String get bugReport => 'Informe de errores';

  @override
  String get bugReportSupportingText => 'Por favor, elige lo que te gustaría incluir en el informe de errores. Cuanta más información proporciones, más fácil será averiguar exactamente qué salió mal. **No se compartirá ninguna información personal.**';
  ...
  @override
  String get uploadCustomColorScheme => 'Subir un esquema del color personalizado';

  @override
  String get downloadCurrentColorScheme => 'Descargar el esquema actual del color';
  ...
  @override
  String get closeDetailsOnCompelteDescription => 'Guarda todos los cambios y cierra la vista de los detalles al completar la tarea.';

  @override
  String get customColorTheme => 'Tema personalizado';

  @override
  String get discardCustomColorTheme => 'Eliminarás todos los cambios realizados al tema.';
  ...
  @override
  String get customThemeInfo => 'Aquí puedes cambiar cada uno de los colores de los diferentes elementos a tu gusto. También puedes importar / exportar los colores en un archivo `json` y editarlos en él.\n\nSi quieres saber qué significa cada elemento, puedes visitar la siguiente página: https://m3.material.io/foundations/design-tokens';

  @override
  String get import => 'Importar';

  @override
  String get customThemeFuckedFile => 'Este archivo no contiene un tema de color válido. Por favor, comprueba que tu archivo sigue el mismo estilo y estructura que el archivo que exportaste.';
  ...
  @override
  String get fediDoablePost => '¡Acabo de terminar todas mis tareas gracias a @Doable@floss.social!\n\n¿Te parece interesante? ¡Puedes saber más sobre #Doable visitando https://repo.doable.at!';

  @override
  String get doable => 'Doable – La aplicación para las tareas moderna y sencilla';
  ...
  @override
  String get recurringTodosDescription => 'Añade recurrencia a tus tareas y deja que Doable las reprograme automáticamente para ti una vez las hayas completado. Las tareas serán reprogramadas en base a la fecha de vencimiento y el calendario que establezcas. Si no agregaste una fecha de vencimiento a tu tarea, en su lugar se utilizará la fecha en que la creaste.\n\n**Una cosa a tener en cuenta: Aunque ahora puedes configurar las tareas para que se repitan en Doable, ten en cuenta que actualmente esta función está limitada al inglés.**';
  ...
  @override
  String get extensionBetaWarningDescription => 'Esta extensión aún está en fase beta y es posible que encuentres algunos problemas al utilizarla. ¡Ten en cuenta los riesgos y avísame si encuentras algún problema!';
  ...
  @override
  String get showFediButtonDescription => 'Muestra un botón que te permite publicar en tu lista vacía en Fediverse';
  ...
  @override
  String get notifyAllDescription => 'Mostrar una notificación de cada tarea con una fecha de vencimiento';

  @override
  String get notifyTimeOnly => 'Solo tareas con tiempo';

  @override
  String get notifyTimeOnlyDescription => 'Recibe notificaciones solo de las tareas que tengan fecha y hora de vencimiento';

  @override
  String get notifyTodosChannelName => 'Tareas';

  @override
  String get notificationsDescription => 'Permita que Doable le notifique cuando sus Todos vencen. También puedes cambiar para qué Todos recibirás notificaciones.';

  @override
  String get notificationsDescriptionShort => 'Cambia las tareas para que te notifiquen';

  @override
  String get notifyNeverDescription => 'No recibir notificaciones de ninguna tarea';

  @override
  String get defaultNotificationTime => 'Hora de notificación por defecto';

  @override
  String get defaultNotificationTimeDescription => 'La hora a la que se le notificará las tareas que no tienen una hora relevante';
  ...
  @override
  String get todoImagesDescription => 'Añade imágenes a tus tareas para dar más contexto a lo que escribes.\n\n**Desgraciadamente las imágenes no se sincronizarán todavía.**';
  ...
  @override
  String get apkSignatureInvalidDescription => 'No se ha podido verificar la firma del archivo apk descargado. Por favor, notifique al desarrollador acerca de este problema. Aunque puedes instalar el apk por tu cuenta y riesgo, te recomendamos precaución por posibles problemas de seguridad.';
  ...
  @override
  String get readerModeDescription => 'Le permite obtener una vista previa de sus tareas en la vista de edición.';
  ...
  @override
  String get readerModeDescriptionShort => 'Cambiar el modo inicial al abrir una tarea';

  @override
  String get lastUsed => 'Último uso';

  @override
  String get syncFileLocked => 'El servidor ha bloqueado un archivo de copia de seguridad, por favor inténtelo de nuevo en unos 15 minutos.';

  @override
  String get syncInternalError => 'Se ha producido un error interno, disculpen las molestias.';

  @override
  String get syncConnectionError => 'Se ha producido un error al conectar con el servidor.';
  ...
  @override
  String get migratingNextcloudToRemote => 'Migración de Nextcloud a una nueva implementación de sincronización…';

  @override
  String get migratingWebdavToRemote => 'Migración de Webdav a una nueva implementación de sincronización…';

  @override
  String get migrateToRemotes => 'Migración';

  @override
  String get migrateToRemotesDescription => 'Doable ha cambiado recientemente su forma de sincronizar con remotas como Nextcloud o Webdav. Desafortunadamente, la nueva implementación no es compatible con versiones anteriores y, por lo tanto, es necesario realizar una migración. Doable debería necesitar un minuto para migrar todo lo que necesita.\n\nSi eliges hacerlo más tarde puede que encuentres algunos mensajes de error ya que la nueva implementación aún no ha sido configurada.';

  @override
  String get fixBrokenRemoteFile => 'Un archivo de copia de seguridad de Doable parece estar corrupto. Doable puede arreglarlo anulándolo con el valor local actual. Esto anulará cualquier cambio realizado por otros dispositivos después de que se produjera ese error.';
  ...
  @override
  String get syncFileDoesNotExist => 'No existe un archivo de copia de seguridad de Doable.';

  @override
  String get todos => 'Tareas';

  @override
  String get selectWhatToExport => 'Por favor, seleccione lo que desea exportar.';
  ...
  @override
  String get listColorAsAccentDescription => 'Utilice el color de la lista actual como color de acento para Doable';
  ...
  @override
  String get aboutOpenSource => 'Se puede acceder a todo el código fuente de Doable en Codeberg bajo una licencia FOSS. También puede enviar problemas y solicitudes de extracción allí. ¡También puedes encontrar el repositorio F-Droid de Doable en Codeberg!';

  @override
  String get aboutPrivacy => 'Doable no recoge ninguna información personal. Lo único que Doable almacena sobre su uso son los registros. La única manera de que estos registros salgan de su dispositivo es si usted decide compartirlos, por ejemplo, para ayudarme a corregir un error.';
  ...
  @override
  String get enableNotificationSoundDescription => 'Reproduce un sonido personalizado al mostrar una notificación';
  ...
  @override
  String get showListDescription => 'Muestre las tareas de esta lista en la descripción general.';

  @override
  String get hideListDescription => 'No mostrar las tareas de esta lista en la descripción general.';

  @override
  String get gotIt => 'Entendido';

  @override
  String get updateRelease => 'Abre la página de Doable y descarga la última versión';

  @override
  String get updateDownload => 'Deje que Doable descargue la última versión por usted; encontrará el archivo en el área de notificación y podrá instalarlo haciendo clic en él';

  @override
  String get updateFdroid => 'Si instalaste Doable desde F-Droid deberías recibir la actualización en las próximas horas, ya sea desde el repositorio de IzzyOnDroid o desde el propio repositorio de Doable';

  @override
  String get updateDisable => 'También puede desactivar la comprobación automática de actualizaciones en los ajustes';
  ...
  @override
  String get autoExportDescription => 'Puede dejar que Doable exporte automáticamente sus tareas, listas y ajustes. Tenga en cuenta que Doable creará un nuevo archivo para cada exportación. Elija la duración entre las exportaciones.';
  ...
  @override
  String get swipeActionsDescription => 'Añade la posibilidad de deslizar el dedo hacia la izquierda sobre las tareas para marcarlos como favoritos o completarlos.\n\n**Tenga en cuenta que esto a veces puede confundirse con el cajón de la extensión de las listas.**';
  ...
  @override
  String get forceHighestRefreshRate => 'Forzar la frecuencia de actualización más alta';

  @override
  String get forceHighestRefreshRateDescription => '(Intentar) forzar al sistema a utilizar la mayor frecuencia de actualización posible dentro de la aplicación';
  ...
  @override
  String get expandTodosByDefaultDescription => 'Mostrar Todos como expandidos por defecto';
  ...
  @override
  String get progressBarDescription => 'Agrega una barra de progreso a las tareas, lo que le brinda un control más preciso sobre su estado de finalización.';

  @override
  String get syncMultipleErrors => 'Se han producido varios mensajes de error. Vea el libro de registro para obtener más información.';
  ...
  @override
  String get dateFiltersDescription => 'Agregue la opción de filtrar sus tareas por un rango de fechas específico.';
  ...
  @override
  String get enablePrideFlagsDescription => 'Muestra banderas del Orgullo detrás de la barra de título en ciertos meses';

  @override
  String get enablePrideFlags => 'Habilitar banderas del Orgullo';

  @override
  String get prideFlagRestOfYear => 'La bandera del Orgullo se muestra durante todo el año';
  ...
  @override
  String get defaultNotificationsDescriptionIfLists => 'También puedes elegir diferentes notificaciones para diferentes listas.';
  ...
  @override
  String get defaultNotificationsDescription => 'Seleccione notificaciones predeterminadas que se agregarán a cada tarea pendiente con una fecha relevante.';
  ...
  @override
  String get snoozeDurationDescription => 'Duración del retraso de una notificación al presionar el botón posponer';
  ...
  @override
  String get aboutToCancelChangesToList => 'Está a punto de descartar cualquier cambio en esta lista.';

  @override
  String get notificationsAlwaysPreview => 'Siempre previsualizar las notificaciones';

  @override
  String get notificationsAlwaysPreviewDescription => 'Mostrar siempre notificaciones en modo vista previa (esto no afecta el último modo utilizado)';

  @override
  String get nextcloudWipeDescription => 'Doable recibió una solicitud para borrar todos los datos asociados con la cuenta de Nextcloud con la que iniciaste sesión. Por lo tanto, se cerrará la sesión de tu cuenta. También puedes optar por borrar todos los datos (tareas pendientes y listas) de la aplicación. Esta acción es permanente y no se puede deshacer.';
  ...
  @override
  String get useSystemFontDescription => 'Utilice la fuente del sistema como fuente principal para Doable';

  @override
  String get batteryOptimization => 'Optimización de la batería';

  @override
  String get batteryOptimizationDescription => 'Se puede optimizar la batería. Si bien esto no suele ser un problema, puede generar algunos problemas al iniciar sesión en Nextcloud . Si desea garantizar una experiencia fluida, desactive estas optimizaciones.';

  @override
  String get couldNotAddTodoToCalendar => 'No se pudo añadir la tarea al calendario.';

  @override
  String get sortCompleted => 'Clasificación completada';

  @override
  String get sortCompletedDescription => 'Aplicar la clasificación también a las tareas pendientes de completar';
}
