...
class StringsPt extends Strings {
  ...
  String get aboutToCancelFeedbackDescription =>
      'Estás prestes a descartar o teu feeback. Esta ação não pode ser revertida.';
  ...
  String get additionalFeaturesDescription =>
      'Funcionalidades que tornam o Doable mais poderoso';
  ...
  String get chooseFeedbackExtrasTitle =>
      'Que informação extra gostarias de incluir?';
  ...
  String get feedbackDescriptionHelp =>
      'Uma explicação mais detalhada do que correu mal / como aconteceu.';

  @override
  String get feedbackHeader =>
      'Por favor preenche o formulário abaixo para me ajudar a perceber o que correu mal.';
  ...
  String get introLinksDescription =>
      'Os links, números de telemóvel ou endereços de email que adicionares a uma descrição serão automaticamente destacados e podes interagir com eles.';
  ...
  String get sortNewestFirstDescription =>
      'Datas mais recentes são mostradas no topo';
  ...
  String get syncNotNcServer =>
      'Não foi possível encontrar um servidor Nextcloud neste endereço.';
  ...
  String get introExtensionsDescription =>
      'Extensões permitem-te expandir e alargar as funcionalidades do Doable. Estas dão-te o poder de escolher exatamente como queres usar o Doable. Se quiseres ver todas as extensões disponíveis já basta clicar no botão abaixo!';
  ...
  String get contributorDescription =>
      'Pessoas que ajudaram o Doable a tornar-se no que é';
  ...
  String get restartRequiredForSetting =>
      'É necessário reiniciar a aplicação para esta definição ter efeito.';
  ...
  String get contributeWantYourNameHereDescription =>
      'Contribui diretamente para o Doable ou ajuda a traduzi-lo!';
  ...
  String get discardCustomColorTheme =>
      'Estás prestes a descartar todas as alterações feitas ao esquema de cores.';
  ...
  String get deletedCustomColorTheme =>
      'Esquema de cores personalizado apagado.';
  ...
  String get customThemeFuckedFile =>
      'Este ficheiro não tem um esquema de cores válido. Por favor certifica-te que o teu ficheiro segue o mesmo estilo e estrutura do ficheiro que exportaste.';
...
class StringsPtBr extends StringsPt {
  ...
  @override
  String get aboutToCancelChangesDescription =>
      'Você está prestes a descartar todas as alterações feitas neste Todo.';
  ...
  @override
  String get aboutToCancelFeedbackDescription =>
      'Você está prestes a descartar seu feedback. Isto não pode ser desfeito.';

  @override
  String get aboutToDeleteCompleted =>
      'Você está prestes a apagar todos os Todos concluídos. Essa ação é permanente e não pode ser desfeita.';
  ...
  @override
  String get additionalFeaturesDescription =>
      'Funcionalidades que fazem o Doable mais poderoso';
  ...
  @override
  String get alignTodoCheckDescription =>
      'Mostrar a caixa de seleção TODO no lado direito';
  ...
  String get syncAndBackupDescription =>
      'Fazer backup e sincronizar seus TODOs';
  ...
  @override
  String get chooseFeedbackExtrasDescription =>
      'Recomendei incluir todos os itens a seguir, pois isso me ajuda a solucionar seu problema. Isto não inclui informações pessoais.';

  @override
  String get chooseFeedbackExtrasTitle =>
      'Você gostaria de incluir mais alguma informação?';
  ...
  @override
  String get customAccentPickerDescription =>
      'Escolha uma cor de destaque personalizada para o tema do aplicativo';
  ...
  String get dynamicColorsDescription =>
      'Usar cor padrão do sistema (Android 12+)';
  ...
  @override
  String get feedbackDescriptionHelp =>
      'Uma explicação mais detalhada sobre o que aconteceu de errado e como aconteceu.';

  @override
  String get feedbackHeader =>
      'Preencha o formulário abaixo para me ajudar a entender o que deu errado.';
  ...
  String get generalDescription =>
      'Alterar o comportamento geral do aplicativo';
  ...
  @override
  String get highlightOverdueDescription =>
      'Destaque TODOs que estão atrasados da mesma forma que os TODOs com estrela';
  ...
  @override
  String get highlightTodayDescription =>
      'Destaque os TODOs que vencem hoje da mesma forma que os TODOs com estrela';

  @override
  String get importLocalBackupError =>
      'O arquivo não pôde ser importado. Você tem certeza de que este arquivo foi gerado pelo Doable?';
  ...
  @override
  String get introDoubleTapDescription =>
      'Você pode tocar duas vezes nos TODOs que apresentam uma descrição para expandi-los. Quando expandida, a descrição completa é exibida e você pode interagir com links, etc.\n\nVocê pode experimentar com um exemplo aqui mesmo!';
  ...
  @override
  String get introLinksDescription =>
      'Quando você adicionar links, números de telefone ou endereços de e-mail a uma descrição, eles serão automaticamente destacados e você poderá interagir com eles.';
  ...
  @override
  String get introNextcloudDescription =>
      'Você pode também sincronizar seus afazeres com uma instância da Nextcloud. Se você quiser pode se logar logo aqui!';
  ...
  @override
  String get introWelcomeDescription =>
      'O aplicativo simples de afazeres com design moderno\ne integração com o Nextcloud.';
  ...
  @override
  String get showCompletedTodosDescription =>
      'Mostrar afazeres concluídos na lista';
