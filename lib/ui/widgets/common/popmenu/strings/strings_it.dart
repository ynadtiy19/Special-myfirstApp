...
class StringsIt extends Strings {
  ...
  @override
  String get aboutOSInfo => 'Codice sorgente: [codeberg/flutter-doable](https://www.codeberg.org/florian-obernberger/flutter-doable)\nPrivacy policy: [codeberg/flutter-doable/privacy](https://codeberg.org/florian-obernberger/flutter-doable/src/branch/main/PRIVACY.md)\nRepository F-Droid: [codeberg/fdroid-repo](https://codeberg.org/florian-obernberger/fdroid-repo)\nMastodon: [@doable@floss.social](https://floss.social/@doable)';

  @override
  String get aboutToCancelChanges => 'Annullare modifiche?';

  @override
  String get aboutToCancelChangesDescription => 'Stai per annullare tutte le modifiche fatte a questo Todo.';

  @override
  String get aboutToCancelFeedback => 'Annullare feedback?';

  @override
  String get aboutToCancelFeedbackDescription => 'Stai per cancellare il tuo feedback. Questa azione non può essere annullata.';

  @override
  String get aboutToDeleteCompleted => 'Stai per eliminare tutti i Todos completati. Questa azione è permanente e non può essere annullata.';
  ...
  @override
  String get additionalFeaturesDescription => 'Opzioni che rendono Doable più potente';

  @override
  String get alignTodoCheck => 'Spunta di conferma a destra';

  @override
  String get alignTodoCheckDescription => 'Mostra la spunta di conferma del Todo a destra';
  ...
  @override
  String get syncAndBackupDescription => 'Effettua il back up e sincronizza i tuoi Todos';

  @override
  String get cancel => 'Annulla';

  @override
  String get chooseFeedbackExtrasDescription => 'Consiglio di includere tutto ciò che segue per aiutarmi a risolvere il tuo problema. Questo non include informazioni personali.';

  @override
  String get chooseFeedbackExtrasTitle => 'Quali informazioni extra vuoi includere?';
  ...
  @override
  String get customAccentPickerDescription => 'Scegli un colore d\'accento preferito per il tema dell\'app';
  ...
  @override
  String get dynamicColorsDescription => 'Usa i colori di sistema (Android 12+)';
  ...
  @override
  String get feedbackDescriptionHelp => 'Una spiegazione più dettagliata di cosa è andato storto / come è successo.';

  @override
  String get feedbackHeader => 'Per favore compila il modulo qua sotto per aiutarmi a capire cosa è andato storto.';
  ...
  @override
  String get highlightOverdueDescription => 'Evidenzia i Todos che sono scaduti come i Todos preferiti';

  @override
  String get highlightToday => 'Evidenzia oggi';

  @override
  String get highlightTodayDescription => 'Evidenzia i Todos che scadono oggi come quelli preferiti';

  @override
  String get importLocalBackupError => 'Questo file non può essere importato. Sicuro sia stato generato da Doable?';
  ...
  @override
  String get introDoubleTapDescription => 'Puoi fare un doppio tap su un Todos che ha una descrizione per espanderlo. Quando espanso, viene mostrata la descrizione completa e puoi interagire con i link, ecc.\n\nPuoi provare con questo esempio qui!';

  @override
  String get introDoubleTapTodoDescription => 'La torta è una bugia!\n\nScopri di più qui:\nhttps://theportalwiki.com/wiki/Cake';
  ...
  @override
  String get introLinksDescription => 'Quando aggiungi dei link, numeri di telefono, o indirizzi email a una descrizione, saranno evidenziati automaticamente e puoi interagirci.';

  @override
  String get introNextcloud => 'Nextcloud';

  @override
  String get introNextcloudDescription => 'Puoi sincronizzare i tuoi Todos con un\'istanza Nextcloud. Se vuoi puoi fare già il login qui!';

  @override
  String get introStar => 'Preferiti';

  @override
  String get introStarDescription => 'Aggiungi un Todo ai preferiti\nper farlo salire in cima.\n\nTocca la stella qua sotto per provare!';

  @override
  String get introTodos => 'Todos';

  @override
  String get introTodosDescription => 'Quando crei un nuovo Todo puoi aggiungere diverse cose. Per esempio puoi aggiungere una data di scadenza, oppure puoi metterlo tra i preferiti per tenerlo sempre in alto! Puoi anche aggiungere una descrizione con link e altre informazioni relative al tuo Todo.';

  @override
  String get introWelcome => 'Benvenuto su Doable!';

  @override
  String get introWelcomeDescription => 'L\'app per Todo semplice, con design moderno\ne integrazione Nextcloud.';
  ...
  @override
  String get ncLogOutMessage => 'Quando fai il logout le credenziali salvate verranno cancellate. Comunque, il file salvato su Nextcloud non verrà cancellato.';
  ...
  @override
  String get showCompletedTodosDescription => 'Mostra i Todos completati nella lista';
  ...
  @override
  String get sortNewestFirstDescription => 'Le scadenze più vicine vengono mostrate all\'inizio';
  ...
  @override
  String get syncNotNcServer => 'Impossibile trovare un server Nextcloud a questo indirizzo.';
  ...
  @override
  String get syncWrongUserOrPassword => 'Il nome utente o password fornite non sono corretti.';
  ...
  @override
  String get todoSearchDescription => 'Aggiungi un pulsante di ricerca nella lista Todo per cercare tra i tuoi Todos.';
  ...
  @override
  String get treatTodayAsIsImportantDescription => 'Se attivato, i Todos che scadono oggi saranno mostrati come i preferiti';

  @override
  String get trimTodoTexts => 'Trim testo del Todo';

  @override
  String get trimTodoTextsDescription => 'Se attivato, toglie gli spazi all\'inizio e alla fine del titolo e della descrizione dei Todos';

  @override
  String get trueBlackMode => 'Modalità nera';

  @override
  String get trueBlackModeDescription => 'Rende lo sfondo nero, comodo per display oled';
  ...
  @override
  String get useCustomTabsDescription => 'Usa il browser in-app per aprire link';
  ...
  @override
  String get routingError => 'Oops! Qualcosa è andato storto e sei su una pagina che non esiste. Mi spiace!';
  ...
  @override
  String get couldNotDownloadUpdate => 'Impossibile scaricare l\'aggiornamento.';
  ...
  @override
  String get autoUpdatesDescription => 'Controlla automaticamente aggiornamenti';

  @override
  String get introExtensions => 'Estensioni? Estensioni!';

  @override
  String get introExtensionsDescription => 'Le estensioni ti permettono di aumentare le opzioni di Doable. Ti danno la possibilità di scegliere esattamente come vuoi usare Doable. Se vuoi controllare tutte le estensioni disponibili, premi il pulsante qua sotto!';
  ...
  @override
  String get useBottomSheetMenuDescription => 'Usa il menù in basso invece che il menù a scomparsa';

  @override
  String get contributors => 'Contribuenti';

  @override
  String get contributorDescription => 'Persone che hanno aiutato a creare Doable';
  ...
  @override
  String get webdavLogOutMessage => 'Quando effetti il logout le credenziali salvate verranno cancellate. Comunque, il file non verrà cancellato.';
  ...
  @override
  String get listsDescription => 'Crea liste e ordina i tuoi Todos. Puoi creare quante liste vuoi, sono accessibili dal cassetto nella schermata home.';
  ...
  @override
  String get popUpAnimationOverSlideAnimation => 'Vecchia transizione per la pagina';

  @override
  String get popUpAnimationOverSlideAnimationDescription => 'Usa il vecchio stile pop up per le transizioni';
  ...
  @override
  String get restartRequiredForSetting => 'è richiesto il riavvio dell\'app perché questa impostazione abbia effetto.';
  ...
  @override
  String get doableBrandingText => 'Condiviso da Doable, l\'app semplice e moderna per gestire Todo.\nPuoi scaricare Doable qui: https://codeberg.org/florian-obernberger/flutter-doable';
  ...
  @override
  String get contributeWantYourNameHereDescription => 'Contribuisci a Doable direttamente o aiutaci a tradurlo!';

  @override
  String get onlySymbolInDetailViewFab => 'Icone al posto del testo';

  @override
  String get onlySymbolInDetailViewFabDescription => 'Usa un\'icona al posto del testo nella vista dettagliata del Todo';
  ...
  @override
  String get sharedTextAsTitleDescription => 'Usa il testo condiviso a Doable come titolo di un nuovo Todo invece che della descrizione';

  @override
  String get noTodoLists => 'Al momento non hai nessuna lista.\nCreane una nuova per iniziare!';
  ...
  @override
  String get syncTooManyTimeOuts => 'Il server non ha risposto in tempo. La sincronizzazione è disattivata fino al riavvio dell\'app.';
  ...
  @override
  String get aboutToClearAllLogs => 'Stai per eliminare tutti i log rendendoli inaccessibili per feedback e risoluzione di problemi. Questa azione è permanente e non può essere annullata.';
  ...
  @override
  String get fixCorruptBackupFile => 'Il file di backup di Doable non può essere letto e sembra corrotto. Doable può provare a risolvere eliminando il file di backup corrente e creandone uno nuovo. Questo eliminerà tutte le modifiche fatte da altre istanze Doable che usano lo stesso file di backup.';
  ...
  @override
  String get createSummaryForBugReportDetails => 'Crea un report contenente informazioni di sistema, le impostazioni di Doable e tutti i log. Questo può essere utile per segnalare bug e risolvere problemi.';

  @override
  String get bugReport => 'Riporta un problema';

  @override
  String get bugReportSupportingText => 'Scegli cosa includere nel tuo report. Più informazioni includi, più facile sarà capire cosa è andato storto. **Non vengono condivise informazioni personali**';
  ...
  @override
  String get fontSizeDescription => 'Sovrascrivere la dimensione dei caratteri del sistema';
  ...
  @override
  String get uploadCustomColorScheme => 'Caricare lo schema di colori personalizzato';

  @override
  String get downloadCurrentColorScheme => 'Scarica la combinazione di colori attuale';
  ...
  @override
  String get closeDetailsOnCompelteDescription => 'Salva il Todo e chiude la sua visualizzazione dei dettagli quando si preme il pulsante Completa.';

  @override
  String get customColorTheme => 'Tema colore personalizzato';

  @override
  String get discardCustomColorTheme => 'Si stanno per eliminare tutte le modifiche apportate al tema del colore.';
  ...
  @override
  String get customThemeInfo => 'Qui è possibile modificare ogni singolo token di colore a proprio piacimento. È anche possibile importare/esportare i colori in un file `json` e modificarli lì!\n\nSe volete capire cosa fa ciascun token, visitate il seguente sito web: https://m3.material.io/foundations/design-tokens';

  @override
  String get import => 'Importazione';

  @override
  String get customThemeFuckedFile => 'Questo file non contiene un tema di colore valido. Assicurarsi che il file segua lo stesso stile e la stessa struttura del file esportato.';
  ...
  @override
  String get fediDoablePost => 'Sono appena riuscito a finire tutti i miei Todos grazie a @Doable@floss.social!\n\nVi sembra interessante? Potete scoprire di più su #Doable visitando https://repo.doable.at!';
  ...
  @override
  String get recurringTodosDescription => 'Aggiungi la ricorrenza ai tuoi Todos e lascia che Doable le riprogrammi automaticamente per te una volta completate. I Todos verranno riprogrammati in base alla data pertinente e alla pianificazione impostata. Se non hai aggiunto una data di scadenza al Todo, verrà utilizzata invece la sua data di creazione.\n\n**Una cosa da tenere a mente: anche se ora puoi impostare le attività da ripetere in Doable, per favore considera che attualmente questa funzionalità è limitata all\'inglese.**';
  ...
  @override
  String get extensionBetaWarningDescription => 'Questa estensione è ancora in versione beta e potresti riscontrare qualche problema durante l\'utilizzo. Per favore sii consapevole dei rischi e fammi sapere se riscontri problemi!';
  ...
  @override
  String get showFediButtonDescription => 'Mostra un pulsante che ti consente di pubblicare la tua lista vuota sul Fediverso';
  ...
  @override
  String get notifyAllDescription => 'Ricevi una notifica per ogni Todo che ha una data di scadenza';

  @override
  String get notifyTimeOnly => 'Solo Todos con l\'orario';

  @override
  String get notifyTimeOnlyDescription => 'Ricevi notifiche solo per i Todos che hanno sia una data di scadenza che un orario';

  @override
  String get notifyTodosChannelName => 'Notifiche Todo';

  @override
  String get notificationsDescription => 'Lascia che Doable ti avvisi quando scadono i tuoi Todos. Puoi anche cambiare i Todos per i quali riceverai le notifiche.';

  @override
  String get notificationsDescriptionShort => 'Cambia per quali Todos ricevi le notifiche';
  ...
  @override
  String get defaultNotificationTimeDescription => 'L\'orario in cui riceverai una notifica per i Todos che non hanno un orario rilevante';
  ...
  @override
  String get todoImagesDescription => 'Aggiungi immagini ai tuoi Todos in modo da poter aggiungere più contesto a ciò che stai scrivendo.\n\n**Purtroppo le immagini non saranno ancora sincronizzate.**';
  ...
  @override
  String get apkSignatureInvalidDescription => 'Non è stato possibile verificare la firma del file apk scaricato. Si prega di avvisare lo sviluppatore di questo problema. Anche se puoi procedere con l\'installazione dell\'apk a tuo rischio e pericolo, ti consigliamo di prestare attenzione a causa di potenziali problemi di sicurezza.';
  ...
  @override
  String get readerModeDescription => 'Ti consente di visualizzare in anteprima i tuoi Todos nella schermata di modifica.';
  ...
  @override
  String get readerModeDescriptionShort => 'Cambia la modalità iniziale quando apri un Todo';

  @override
  String get lastUsed => 'Ultimo usato';

  @override
  String get syncFileLocked => 'Il server ha bloccato il file di backup, per favore riprova tra 15 minuti.';

  @override
  String get syncInternalError => 'C\'è stato un errore interno, ci scusiamo per l\'inconveniente.';

  @override
  String get syncConnectionError => 'C\'è stato un errore con la connessione del server.';
  ...
  @override
  String get migratingNextcloudToRemote => 'Migro NextCloud verso una nuova implementazione di sincronizzazione…';
