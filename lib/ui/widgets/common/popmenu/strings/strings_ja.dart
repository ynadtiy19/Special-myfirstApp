...
class StringsJa extends Strings {
  ...
  String get aboutToCancelFeedbackDescription =>
      'フィードバックを破棄しようとしています。破棄をした場合は元に戻せません。';
  ...
  String get chooseFeedbackExtrasDescription =>
      '問題の解決に役立つため、以下のすべての情報を含める事を推奨します。この情報は個人情報は含まれません。';
  ...
  String get highlightOverdueDescription =>
      '期限切れの Todo をスター付きの Todo と同様にハイライトで表示します';
  ...
  String get highlightTodayDescription =>
      'スター付きの Todo と同様に今日に締め切りの Todo をハイライトで表示します';

  @override
  String get importLocalBackupError =>
      'ファイルがインポートできませんでした。Doable で生成をしたファイルですか?';
