...
class StringsJa extends Strings {
  ...
  @override
  String get aboutDescription => 'アプリの詳細情報';

  @override
  String get aboutOSInfo => 'ソースコード: [codeberg/flutter-doable](https://www.codeberg.org/florian-obernberger/flutter-doable)\nプライバシーポリシー: [codeberg/flutter-doable/privacy](https://codeberg.org/florian-obernberger/flutter-doable/src/branch/main/PRIVACY.md)\nF-Droid リポジトリ: [codeberg/fdroid-repo](https://codeberg.org/florian-obernberger/fdroid-repo)\nMastodon: [@doable@floss.social](https://floss.social/@doable)';

  @override
  String get aboutToCancelChanges => '変更を破棄しますか?';

  @override
  String get aboutToCancelChangesDescription => 'この Todo のすべての変更を破棄します。';

  @override
  String get aboutToCancelFeedback => 'フィードバックを破棄しますか?';

  @override
  String get aboutToCancelFeedbackDescription => 'フィードバックを破棄しようとしています。破棄をした場合は元に戻せません。';

  @override
  String get aboutToDeleteCompleted => '完了した Todo をすべて削除します。この操作は永久的に元に戻せません。';
  ...
  String aboutToDeleteNSelected(int count) {
    ...
    return '$_temp0 件の Todo を削除します。この操作は永久的に元に戻せません。';
  }

  @override
  String get additionalFeatures => '機能拡張';

  @override
  String get additionalFeaturesDescription => 'Doable をよりパワフルにする機能です';

  @override
  String get alignTodoCheck => '右のチェックマーク';

  @override
  String get alignTodoCheckDescription => '右側に Todo のチェックマークを表示します';
  ...
  @override
  String get syncAndBackup => 'バックアップと同期';

  @override
  String get syncAndBackupDescription => 'Todo を同期とバックアップをします';

  @override
  String get cancel => 'キャンセル';

  @override
  String get chooseFeedbackExtrasDescription => '問題の解決に役立つため、以下のすべての情報を含める事を推奨します。この情報は個人情報は含まれません。';

  @override
  String get chooseFeedbackExtrasTitle => 'どの追加情報を挿入しますか?';

  @override
  String get chooseFeedbackWay => 'フィードバックの送信先はどこにしますか?';

  @override
  String get codeberg => 'Codeberg';

  @override
  String get completedTodo => 'Todo が完了しました。';

  @override
  String get copiedToClipboard => 'クリップボードにテキストをコピーしました。';

  @override
  String get customAccentPicker => 'アクセントカラー';

  @override
  String get customAccentPickerDescription => 'アプリのテーマに合わせてカスタムアクセントカラーを選択します';

  @override
  String get darkMode => 'ダークモード';

  @override
  String get deleteCompletedAfter => '完了時に自動で削除する';

  @override
  String deleteCompletedAfterDescription(String duration) {
    return '$duration の経過後に自動で削除をします';
  }
  ...
  @override
  String get designDescription => 'Doable の外観を変更します';
  ...
  @override
  String get dynamicColorsDescription => 'システムの配色を使用します (Android 12+)';
  ...
  @override
  String get exportAllTodos => 'すべての Todo をエクスポート';
  ...
  @override
  String get feedbackDescriptionHelp => '問題点や経緯などのより詳細な説明。';

  @override
  String get feedbackHeader => 'どのような問題が発生したのかを伝えるために以下のフォームに入力をしてください。';

  @override
  String get feedbackTitleHelp => '問題ついての簡単な概要。';

  @override
  String get general => '一般';

  @override
  String get generalDescription => 'アプリの一般的な動作を変更します';

  @override
  String get giveFeedback => 'フィードバック';

  @override
  String get highlightOverdue => '期限切れのハイライト';

  @override
  String get highlightOverdueDescription => '期限切れの Todo をスター付きの Todo と同様にハイライトで表示します';

  @override
  String get highlightToday => '今日をハイライトで表示';

  @override
  String get highlightTodayDescription => 'スター付きの Todo と同様に今日に締め切りの Todo をハイライトで表示します';

  @override
  String get importLocalBackupError => 'ファイルがインポートできませんでした。Doable で生成をしたファイルですか?';

  @override
  String get importTodosFromFile => 'ファイルをインポート';
  ...
  @override
  String get introDoubleTap => 'ダブルタップ';
  ...
  @override
  String get introDoubleTapTodoDescription => 'そのケーキは存在しない\n\n詳しくはこちら:\nhttps://theportalwiki.com/wiki/Cake';

  @override
  String get introDoubleTapTodoTitle => '新しいケーキを買う';

  @override
  String get introLinks => 'リンク、電話番号、メール';
  ...
  @override
  String get introWelcome => 'Doable へようこそ!';
  ...
  @override
  String get licensesDescription => 'オープンソースと Flutter のライセンス';

  @override
  String get localStorage => '内部ストレージ';
  ...
  @override
  String get logOutputs => 'ログ';

  @override
  String get markCompleted => '完了済みをマーク';
  ...
  @override
  String get markUncompleted => '未完了をマーク';

  @override
  String get markdown => 'Markdown';

  @override
  String get markdownDescription => 'Markdown をサポートします';

  @override
  String get mayNotBeEmpty => '空欄ではない可能性があります';
  ...
  @override
  String get languageNameInNativeLanguage => '日本語';
