...
class StringsPl extends Strings {
  ...
  String get aboutToCancelChangesDescription =>
      'Właśnie porzucasz wszystkie zmiany wprowadzone do tego zadania.';
  ...
  String get aboutToCancelFeedbackDescription =>
      'Właśnie porzucasz swoją opinię. Tego nie da się cofnąć.';

  @override
  String get aboutToDeleteCompleted =>
      'Właśnie usuwasz wszystkie ukończone zadania. To działanie jest trwałe i nie można go cofnąć.';
  ...
  String get additionalFeaturesDescription =>
      'Funkcje, które zwiększają możliwości Doable';
  ...
  String get alignTodoCheckDescription =>
      'Pokazuj znak wyboru zadań po prawej stronie';
  ...
  String get syncAndBackupDescription =>
      'Twórz kopie zapasowe i synchronizuj swoje zadania';
  ...
  String get chooseFeedbackExtrasDescription =>
      'Zalecam dołączenie wszystkich poniższych informacji, ponieważ pomagają mi one w rozwiązywaniu problemów. Nie obejmuje to żadnych informacji osobistych.';

  @override
  String get chooseFeedbackExtrasTitle =>
      'Jakie dodatkowe informacje chcesz zamieścić?';
  ...
  String get customAccentPickerDescription =>
      'Wybierz niestandardowy kolor akcentu dla motywu aplikacji';
  ...
  String get feedbackDescriptionHelp =>
      'Bardziej szczegółowe wyjaśnienie, co poszło nie tak / jak to się stało.';

  @override
  String get feedbackHeader =>
      'Proszę wypełnić poniższy formularz, aby pomóc mi zrozumieć, co poszło nie tak.';
  ...
  String get highlightOverdueDescription =>
      'Oznacz zaległe zadania w ten sam sposób jak zadania oznaczone gwiazdką';
  ...
  String get highlightTodayDescription =>
      'Oznacz zadania, które mają być wykonane dzisiaj, w taki sam sposób jak zadania oznaczone gwiazdką';

  @override
  String get importLocalBackupError =>
      'Nie udało się zaimportować pliku. Czy na pewno został wygenerowany przez Doable?';
  ...
  String get introDoubleTapDescription =>
      'Możesz dwukrotnie przycisnąć zadania, które posiadają opis, aby je rozwinąć. Po rozwinięciu, pokaże się pełny opis i pozwoli to na interakcję z linkami, itp.\n\nMożesz wypróbować to na przykładzie tutaj!';
  ...
  String get introLinksDescription =>
      'Gdy dodasz do opisu linki, numery telefonów lub adresy e-mail, zostaną one automatycznie wyróżnione i umożliwi to interakcję z nimi.';
  ...
  String get introNextcloudDescription =>
      'Możesz również synchronizować swoje zadania z instancją Nextcloud. Jeśli chcesz, możesz zalogować się tutaj!';
  ...
  String get introTodosDescription =>
      'Podczas tworzenia nowego zadania możesz dodać różne rzeczy. Na przykład możesz dodać datę, kiedy zadanie stanie się ważne, lub dodać gwiazdkę, aby wyróżnić je spośród innych! Możesz również dodać opis z linkami lub innymi informacjami związanymi z zadaniem.';
  ...
  String get introWelcomeDescription =>
      'Prosta aplikacja listy zadań z nowoczesnym\ndesignem i integracją z Nextcloud.';
  ...
  String get moveImportantToTopDescription =>
      'Jeśli włączone, zadania oznaczone gwiazdką będą zawsze wyświetlane na górze listy';
  ...
  String get moveUpWhenUpdatedDescription =>
      'Zadania po zmianie przesuwają się na górę listy';
  ...
  String get ncLogOutMessage =>
      'Podczas wylogowania zapisane dane uwierzytelniające zostaną usunięte, ale zapisany plik na twojej instancji Nextcloud pozostanie zachowany.';
  ...
  String get showCompletedTodosDescription =>
      'Wyświetlaj ukończone zadania na liście';
  ...
  String get sortNewestFirstDescription =>
      'Nowsze zadania są wyświetlane na górze';
  ...
  String get syncCorruptedFile =>
      'Plik kopii zapasowej wydaje się być uszkodzony.';
  ...
  String get syncNotNcServer =>
      'Nie udało się znaleźć serwera Nextcloud pod tym adresem.';
  ...
  String get todoSearchDescription =>
      'Dodaje przycisk wyszukiwania do listy zadań umożliwiający przeszukiwanie zadań.';
  ...
  String get treatTodayAsIsImportantDescription =>
      'Jeśli włączone, zadania, które mają być wykonane dzisiaj, będą traktowane tak, jakby były oznaczone gwiazdką';
  ...
  String get trimTodoTextsDescription =>
      'Jeśli jest włączone, usuwa wszelkie otaczające znaki niedrukowalne z tytułu i opisu zadania';
  ...
  String get trueBlackModeDescription =>
      'Sprawia, że tło jest czarne, szczególnie przydatne dla urządzeń z wyświetlaczem OLED';
  ...
  String get useCustomTabsDescription =>
      'Używaj przeglądarki w aplikacji do otwierania linków';
  ...
  String get routingError =>
      'Ups! Wygląda na to, że coś poszło nie tak i trafiłeś(aś) na stronę, która, no cóż, nie istnieje. Bardzo mi przykro z tego powodu!';
  ...
  String get introExtensionsDescription =>
      'Rozszerzenia pozwalają na rozszerzenie i powiększenie funkcjonalności Doable. Dają możliwość wyboru, w jaki sposób chcesz używać Doable. Jeśli chcesz sprawdzić wszystkie dostępne rozszerzenia, po prostu kliknij przycisk poniżej!';
  ...
  String get useBottomSheetMenuDescription =>
      'Używaj menu dolnego zamiast menu rozwijalnego';
  ...
  String get contributorDescription =>
      'Osoby, które pomogły Doable stać się tym, czym jest';
  ...
  String get webdavLogOutMessage =>
      'Podczas wylogowania zapisane dane uwierzytelniające zostaną usunięte, ale zapisany plik zostanie zachowany.';
  ...
  String get listsDescription =>
      'Twórz listy i sortuj za ich pomocą swoje zadania. Możesz stworzyć nieograniczoną ilość list, dostępnych poprzez szufladę na ekranie głównym.';
  ...
  String get popUpAnimationOverSlideAnimation =>
      'Stare przejście między stronami';

  @override
  String get popUpAnimationOverSlideAnimationDescription =>
      'Używaj starego skocznego przejścia między stronami';
  ...
  String get restartRequiredForSetting =>
      'Aby to ustawienie zaczęło obowiązywać, konieczne jest ponowne uruchomienie aplikacji.';
  ...
  String get doableBrandingText =>
      'Udostępnione z Doable, prostej, nowoczesnej i łatwej w użyciu aplikacji listy zadań.\nMożesz pobrać Doable tutaj: https://codeberg.org/florian-obernberger/flutter-doable';

  @override
  String get chooseTodoShareType =>
      'Wybierz, w jaki sposób chcesz udostępnić swoje zadania';
  ...
  String get contributeWantYourNameHereDescription =>
      'Przyczyń się bezpośrednio do Doable lub pomóż w jego tłumaczeniu!';
  ...
  String get onlySymbolInDetailViewFabDescription =>
      'Używaj ikony zamiast tekstu w widoku szczegółów zadania';
  ...
  String get sharedTextAsTitleDescription =>
      'Używaj tekst udostępniony do Doable jako tytuł nowego zadania zamiast jego opisu';

  @override
  String get noTodoLists =>
      'Obecnie nie masz żadnych list.\nUtwórz nową aby zacząć!';
  ...
  String get syncTooManyTimeOuts =>
      'Serwer przekroczył limit czasu zbyt wiele razy. Synchronizacja jest wyłączona do momentu ponownego uruchomienia aplikacji.';
  ...
  String get logsDescription =>
      'Pokaż wszystkie zdarzenia, które wypisuje Doable';

  @override
  String get aboutToClearAllLogs =>
      'Zamierzasz usunąć wszystkie zdarzenia, czyniąc je niedostępnymi dla opinii i rozwiązywania problemów. To działanie jest trwałe i nie może być cofnięte.';
  ...
  String get fixCorruptBackupFile =>
      'Nie można odczytać pliku kopii zapasowej Doable i wygląda na to, że jest on uszkodzony. Doable może spróbować go naprawić, usuwając bieżący plik kopii zapasowej i tworząc nowy. Spowoduje to usunięcie wszystkich zmian w innych wykonalnych wystąpieniach przy użyciu tego samego pliku kopii zapasowej.';
  ...
  String get createSummaryForBugReportDetails =>
      'Tworzy raport zawierający informacje o systemie, ustawienia Doable i wszystkie dzienniki. Może to być przydatne w przypadku zgłaszania błędów i pomaga w rozwiązywaniu problemów.';
  ...
  String get bugReportSupportingText =>
      'Wybierz, co chcesz uwzględnić w zgłoszeniu błędu. Im więcej informacji podasz, tym łatwiej będzie dowiedzieć się, co dokładnie poszło nie tak. **Żadne dane osobowe nie zostaną udostępniane.**';
  ...
  String get uploadCustomColorScheme =>
      'Prześlij niestandardową paletę kolorów';
  ...
  String get closeDetailsOnCompelteDescription =>
      'Zapisuje zadanie i zamyka jego widok szczegółowy po naciśnięciu przycisku zakończenia.';
  ...
  String get discardCustomColorTheme =>
      'Wszystkie zmiany wprowadzone w motywie zostaną odrzucone.';
  ...
  String get deletedCustomColorTheme =>
      'Usunięto niestandardowy motyw kolorystyczny.';

  @override
  String get customThemeInfo =>
      'Tutaj możesz zmienić każdy token koloru do woli. Możesz także importować / eksportować kolory do pliku `json` i tam je edytować!\n\nJeśli chcesz zrozumieć, co robi każdy token, odwiedź następującą stronę internetową: https://m3.material.io/foundations/design-tokens';
  ...
  String get customThemeFuckedFile =>
      'Ten plik nie zawiera prawidłowego motywu kolorów. Upewnij się, że Twój plik ma taki sam styl i strukturę jak plik, który wyeksportowałeś.';
  ...
  String get fediDoablePost =>
      'Właśnie udało mi się ukończyć wszystkie moje zadania dzięki @Doable@floss.social!\n\nBrzmi interesująco? Możesz dowiedzieć się więcej o #Doable odwiedzając https://repo.doable.at!';

  @override
  String get doable =>
      'Doable - Nowoczesna i prosta aplikacja do zapisywania zadań';
  ...
  String get recurringTodosDescription =>
      'Dodaj powtarzalność do swoich zadań by Doable automatycznie przekładało termin po ich ukończeniu. Termin zadań zostanie zmieniony na podstawie ustawionej daty i harmonogramu. Jeśli nie ustawiono wcześniej terminu zadania, zostanie użyta data jego utworzenia.\n\n**Należy pamiętać, że mimo tego, że można teraz ustawić powtarzalność zadań w Doable, obecnie ta funkcja jest ograniczona do języka angielskiego.**';
  ...
  String get extensionBetaWarningDescription =>
      'Rozszerzenie to jest wciąż w fazie beta i podczas korzystania z niego mogą wystąpić pewne problemy. Pamiętaj o ryzyku i daj mi znać, jeśli napotkasz jakiekolwiek problemy!';
  ...
  String get showFediButtonDescription =>
      'Pokaż przycisk umożliwiający publikowanie informacji o twojej pustej liście na Fediwersum';
  ...
  String get notifyAllDescription =>
      'Wysyłaj powiadomienia o każdym zadaniu z datą wykonania';
  ...
  String get notifyTimeOnlyDescription =>
      'Jedynie wysyłaj powiadomienia o zadaniach z datą i czasem wykonania';
  ...
  String get notificationsDescription =>
      'Pozwól Doable powiadamiać Cię, gdy nadejdzie termin Twoich zadań. Możesz także zmienić, dla których zadań będziesz otrzymywać powiadomienia.';

  @override
  String get notificationsDescriptionShort =>
      'Zmień dla których zadań będziesz otrzymywać powiadomienia';

  @override
  String get notifyNeverDescription =>
      'Nie wysyłaj powiadomień o żadnym z zadań';
  ...
  String get defaultNotificationTimeDescription =>
      'Czas, o którym otrzymasz powiadomienie w przypadku zadań, które nie mają oznaczonego czasu';
  ...
  String get todoImagesDescription =>
      'Dodaj zdjęcia do swoich zadań, by ukontekstualizować to, co piszesz.\n\n**Niestety obrazy aktualnie nie są synchronizowane.**';
  ...
  String get apkSignatureInvalidDescription =>
      'Nie udało się zweryfikować sygnatury pobranego pliku apk. Prosimy o powiadomienie dewelopera o tym problemie. Chociaż możesz kontynuować instalację pliku apk na własne ryzyko, zalecamy ostrożność ze względu na obawy dotyczące bezpieczeństwa.';
  ...
  String get readerModeDescription =>
      'Umożliwia podgląd zadań na ekranie edycji.';
  ...
  String get readerModeDescriptionShort =>
      'Zmień tryb początkowy przy otwieraniu zadań';
  ...
  String get syncFileLocked =>
      'Serwer zablokował plik kopii zapasowej, spróbuj ponownie za około 15 minut.';

  @override
  String get syncInternalError =>
      'Wystąpił błąd wewnętrzny, przepraszamy za niedogodności.';

  @override
  String get syncConnectionError =>
      'Wystąpił błąd podczas łączenia się z serwerem.';
  ...
  String get migratingNextcloudToRemote =>
      'Migrowanie Nextcloud do nowej implementacji synchronizacji…';

  @override
  String get migratingWebdavToRemote =>
      'Migrowanie WebDAV do nowej implementacji synchronizacji…';
  ...
  String get migrateToRemotesDescription =>
      'Doable niedawno zmieniło sposób synchronizacji z zewnętrznymi serwisami jak Nextcloud lub WebDAV. Niestety nowa implementacja nie jest zgodna z wcześniejszą i musi nastąpić migracja. Migracja wszystkiego, co potrzebne zajmie około minutę.\n\nJeśli zdecydujesz się zrobić to później, możesz napotkać komunikaty o błędach, ponieważ nowa implementacja nie została jeszcze skonfigurowana.';

  @override
  String get fixBrokenRemoteFile =>
      'Plik kopii zapasowej Doable wydaje się być uszkodzony. Doable może to naprawić, zastępując go bieżącą, lokalną wartością. Zastąpi to wszelkie zmiany wprowadzone przez inne urządzenia po wystąpieniu tego błędu.';
  ...
  String get syncFileDoesNotExist =>
      'Plik kopii zapasowej Doable nie istnieje.';
  ...
  String get listColorAsAccentDescription =>
      'Używaj koloru bieżącej listy jako koloru akcentu aplikacji';
  ...
  String get aboutOpenSource =>
      'Cały kod źródłowy Doable jest dostępny na Codeberg na wolnej i otwartej licencji. Można tam również przesyłać zgłoszenia i wnieść własny kod. Na Codeberg można również znaleźć repozytorium F-Droid Doable!';

  @override
  String get aboutPrivacy =>
      'Doable nie gromadzi żadnych danych osobowych użytkownika. Jedyną rzeczą związaną z użytkowaniem aplikacji, którą Doable przechowuje, są logi. Te logi jednak **nie są przesyłane automatycznie**. Jedynym sposobem, w którym mogą opuścić urządzenie użytkownika, to udostępnienie ich, na przykład w celu naprawienia błędu.';
  ...
  String get enableNotificationSoundDescription =>
      'Odtwórz niestandardowy dźwięk podczas wyświetlania powiadomienia';
  ...
  String get hideListDescription =>
      'Nie pokazuj zadania z tej listy w przeglądzie.';
  ...
  String get updateRelease =>
      'Otwórz stronę wydań Doable i pobierz najnowszą wersję';

  @override
  String get updateDownload =>
      'Pozwól Doable pobrać najnowszą wersję; plik znajdziesz w powiadomieniach i po kliknięciu będzie zainstalowany';

  @override
  String get updateFdroid =>
      'Jeśli Doable zostało pobrane z F-Droid, powinno być zaktualizowane w ciągu najbliższych kilku godzin z repozytorium IzzyOnDroid lub repozytorium Doable';

  @override
  String get updateDisable =>
      'Możesz również wyłączyć automatyczne sprawdzanie aktualizacji w ustawieniach';
  ...
  String get autoExportDescription =>
      'Możesz pozwolić Doable na automatyczne eksportowanie Twoich zadań, list i ustawień. Pamiętaj, że Doable utworzy nowy plik dla każdego eksportu! Wybierz odpowiednio czas trwania między eksportami.';
  ...
  String get swipeActionsDescription =>
      'Dodaje możliwość przesunięcia palcem w lewo na zadaniu, aby je oznaczyć gwiazdką lub ukończyć.\n\n**Uwaga: może to czasami kolidować z szufladą rozszerzenia Listy..**';
  ...
  String get forceHighestRefreshRate =>
      'Wymuś najwyższą częstotliwość odświeżania';

  @override
  String get forceHighestRefreshRateDescription =>
      '(Spróbuj) zmusić system do korzystania z najwyższej możliwej częstotliwości odświeżania w aplikacji';
  ...
  String get expandTodosByDefaultDescription =>
      'Domyślnie wyświetlaj zadania jako rozwinięte';
  ...
  String get progressBarDescription =>
      'Dodaje pasek postępu do zadań, zapewniając lepszą kontrolę nad stanem ich ukończenia.';

  @override
  String get syncMultipleErrors =>
      'Pilot napotkał wiele błędów. Szczegółowe informacje można znaleźć w dziennikach.';
  ...
  String get dateFiltersDescription =>
      'Dodanie opcji filtrowania zadań według określonego zakresu dat.';
  ...
  String get enablePrideFlagsDescription =>
      'Pokazuje flagi Pride za paskiem tytułu w niektórych miesiącach';
