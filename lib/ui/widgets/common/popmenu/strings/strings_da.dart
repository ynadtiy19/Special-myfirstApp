...
class StringsDa extends Strings {
  ...
  String get aboutToCancelChangesDescription =>
      'Du er ved at kassere alle ændringer i denne opgave.';
  ...
  String get aboutToCancelFeedbackDescription =>
      'Du er ved at kassere din feedback. Dette kan ikke fortrydes.';

  @override
  String get aboutToDeleteCompleted =>
      'Du er ved at slette alle fuldførte opgaver. Denne handling er permanent og kan ikke fortrydes.';
  ...
  String get additionalFeaturesDescription =>
      'Funktioner, der gør Doable mere kraftfuld';
  ...
  String get alignTodoCheckDescription =>
      'Vis afkrydsningsfelt for opgaver på højre side';
  ...
  String get syncAndBackupDescription =>
      'Sikkerhedskopiér og synkronisér dine opgaver';
  ...
  String get chooseFeedbackExtrasDescription =>
      'Jeg anbefaler at inkludere alt det følgende, da det hjælper mig med at fejlfinde dit problem. Dette inkluderer ingen personlige oplysninger.';

  @override
  String get chooseFeedbackExtrasTitle =>
      'Hvilke ekstra oplysninger ønsker du at inkludere?';
  ...
  String get customAccentPickerDescription =>
      'Vælg en tilpasset accentfarve til appens tema';
  ...
  String get feedbackDescriptionHelp =>
      'En mere detaljeret forklaring af hvad der gik galt / hvordan det skete.';

  @override
  String get feedbackHeader =>
      'Udfyld venligst formularen nedenfor for at hjælpe mig med at forstå, hvad der gik galt.';
  ...
  String get highlightOverdueDescription =>
      'Fremhæv opgaver, der er forfaldne, på samme måde som stjernemarkerede opgaver';
  ...
  String get highlightTodayDescription =>
      'Fremhæv opgaver, der forfalder i dag, på samme måde som stjernemarkerede opgaver';

  @override
  String get importLocalBackupError =>
      'Filen kunne ikke importeres. Er du sikker på, at det var genereret af Doable?';
  ...
  String get introDoubleTapDescription =>
      'Du kan dobbelt trykke på opgaver, der har en beskrivelse, for at udvide dem. Når de er udvidet, vises den fulde beskrivelse, og du kan derefter interagere med links, osv.\n\nDu kan prøve det med et eksempel lige her!';
  ...
  String get introLinksDescription =>
      'Når du føjer links, telefonnumre eller e-mailadresser til en beskrivelse, fremhæves de automatisk, og du kan interagere med dem.';
  ...
  String get introNextcloudDescription =>
      'Du kan også synkronisere dine opgaver med en Nextcloud-instans. Hvis du vil, kan du logge ind lige her!';
  ...
  String get introTodosDescription =>
      'Når du opretter en ny opgave, kan du tilføje adskillige ting. F.eks kan du tilføje en dato, hvor opgaven bliver relevant, eller du kan stjernemarkere opgaven for at skille den ud fra mængden! Du kan også tilføje en beskrivelse med links eller andre oplysninger relateret til opgaven.';
  ...
  String get introWelcomeDescription =>
      'Den enkle opgave-app med moderne design\nog Nextcloud-integration.';
  ...
  String get moveImportantToTopDescription =>
      'Hvis aktiveret, vil stjernemarkerede opgaver altid blive vist øverst på listen';
  ...
  String get moveUpWhenUpdatedDescription =>
      'Opgaver flyttes øverst på listen efter ændring';
  ...
  String get ncLogOutMessage =>
      'Når du logger ud, slettes dine gemte adgangsoplysninger. Dog vil den gemte fil på din Nextcloud-instans forblive.';
  ...
  String get syncNotNcServer =>
      'Kunne ikke finde en Nextcloud-server på denne adresse.';
  ...
  String get syncWrongUserOrPassword =>
      'Det angivne brugernavn eller adgangskode er forkert.';
  ...
  String get todoSearchDescription =>
      'Føj en søgeknap til opgavelisten, så du kan søge i dine opgaver.';
  ...
  String get treatTodayAsIsImportantDescription =>
      'Hvis aktiveret, vil opgaver, der forfalder i dag, behandles som stjernemarkerede';
  ...
  String get trimTodoTextsDescription =>
      'Hvis aktiveret, fjernes omgivende mellemrum fra opgavens titel og beskrivelse';
  ...
  String get trueBlackModeDescription =>
      'Gør baggrunden sort, især nyttigt til OLED-enheder';
  ...
  String get useCustomTabsDescription =>
      'Brug en in-app browser til at åbne links';
  ...
  String get routingError =>
      'Ups! Det ser ud til, at noget gik galt, og du er havnet på en side, der ikke eksisterer. Det er jeg frygtelig ked af!';
  ...
  String get introExtensionsDescription =>
      'Udvidelser lader dig udvide og forstørre funktionssættet i Doable. De giver dig magten til at vælge præcis, hvordan du vil bruge Doable. Hvis du vil tjekke alle tilgængelige udvidelser, skal du bare klikke på knappen nedenfor!';
  ...
  String get useBottomSheetMenuDescription =>
      'Brug et bundark i stedet for en rullemenu som menu';
  ...
  String get contributorDescription =>
      'Personer, der hjalp Doable med at blive, hvad det er';
  ...
  String get webdavLogOutMessage =>
      'Når du logger ud, vil dine gemte adgangsoplysninger slettes. Dog vil den gemte fil forblive.';
  ...
  String get listsDescription =>
      'Opret lister og sortér dine opgaver med dem. Du kan oprette et ubegrænset antal lister, som er tilgængelige gennem en skuffe på startskærmen.';
  ...
  String get popUpAnimationOverSlideAnimationDescription =>
      'Brug den gamle pop op-sideovergang';
  ...
  String get restartRequiredForSetting =>
      'En app-genstart er påkrævet for at denne indstilling træder i kraft.';
  ...
  String get contributeWantYourNameHereDescription =>
      'Bidrag til Doable direkte eller hjælp med oversættelsen!';
  ...
  String get onlySymbolInDetailViewFabDescription =>
      'Brug et ikon i stedet for tekst i opgavens detaljevisning';
  ...
  String get sharedTextAsTitleDescription =>
      'Brug tekst delt til Doable som titlen af den nye opgave i stedet for dens beskrivelse';

  @override
  String get noTodoLists =>
      'Du har i øjeblikket ingen lister.\nOpret en ny for at komme i gang!';
  ...
  String get syncTooManyTimeOuts =>
      'Serveren udløb for mange gange. Synkronisering er deaktiveret, indtil appen genstartes.';
  ...
  String get aboutToClearAllLogs =>
      'Du er ved at slette alle logfiler og gøre dem utilgængelige for feedback og fejlfinding. Denne handling er permanent og kan ikke fortrydes.';
  ...
  String get noLogsYet =>
      'Der er i øjeblikket ingen logfiler, du kan kigge på.';
  ...
  String get fixCorruptBackupFile =>
      'Sikkerhedskopifilen for Doable kunne ikke læses og virker beskadiget. Doable kan prøve at rette det ved at slette den nuværende sikkerhedskopifil og oprette en ny. Dette sletter alle ændringer foretaget i andre Doable-instanser med den samme sikkerhedskopifil.';
  ...
  String get createSummaryForBugReportDetails =>
      'Opret en rapport med systemoplysninger, Doable\'s indstillinger og alle logfiler. Dette kan være nyttigt til fejlrapporter og hjælper med at løse et problem.';
  ...
  String get bugReportSupportingText =>
      'Vælg venligst, hvad du vil inkludere i fejlrapporten. Jo mere information du giver, jo lettere er det at finde ud af præcis, hvad der gik galt. **Ingen personlige oplysninger deles.**';
  ...
  String get closeDetailsOnCompelteDescription =>
      'Gemmer opgaven, og lukker dens detaljevisning ved tryk på \'Fuldfør\'-knappen.';
  ...
  String get discardCustomColorTheme =>
      'Du er ved at kassere alle ændringer foretaget i farvetemaet.';
  ...
  String get customThemeInfo =>
      'Her kan du ændre hver eneste farvetoken, præcis som du ønsker. Du kan også importere/eksportere farverne til en `json`-fil og redigere dem der!\n\nHvis du vil forstå, hvad hver token gør, kan du besøge følgende hjemmeside: https://m3.material.io/foundations/design-tokens';
  ...
  String get customThemeFuckedFile =>
      'Denne fil indeholder ikke et gyldigt farvetema. Sørg for, at din fil følger samme stil og struktur som den fil, du eksporterede.';
  ...
  String get recurringTodosDescription =>
      'Føj gentagelse til dine opgaver, og lad Doable automatisk omlægge dem for dig, når du har fuldført dem. Opgaverne omlægges baseret på den relevante dato og den tidsplan, du har indstillet. Hvis du ikke har føjet en forfaldsdato til din opgave, bruges dens oprettelsesdato i stedet.\n\n**Én ting at huske på: Selvom du nu kan indstille opgaver til gentagelse i Doable, bedes du bemærke, at denne funktion i øjeblikket er begrænset til engelsk.**';
  ...
  String get extensionBetaWarningDescription =>
      'Denne udvidelse er stadig i beta, så du støder måske på nogle mindre udfordringer under brugen af den. Vær opmærksom på risiciene og lad mig vide, hvis du oplever problemer!';
  ...
  String get showFediButtonDescription =>
      'Vis en knap, der giver dig mulighed for at skrive om din tomme liste til Fediverse';
  ...
  String get notifyAllDescription =>
      'Få besked for hver opgave, der har en forfaldsdato';
  ...
  String get notifyTimeOnlyDescription =>
      'Få kun besked om opgaver, der både har en forfaldsdato og et tidspunkt';
  ...
  String get notificationsDescription =>
      'Lad Doable give dig besked, når dine opgaver forfalder. Du kan også ændre for hvilke opgaver, du vil få notifikationer.';

  @override
  String get notificationsDescriptionShort =>
      'Ændre, hvilke opgaver du får besked om';
  ...
  String get defaultNotificationTimeDescription =>
      'Den tid, du vil få besked om for opgaver, der ikke har et relevant tidspunkt';
  ...
  String get todoImagesDescription =>
      'Føj billeder til dine opgaver, så du kan føje mere kontekst til det, du skriver.\n\n**Desværre synkroniseres billeder ikke endnu.**';
  ...
  String get apkSignatureInvalidDescription =>
      'Signaturen på den hentede APK-fil kunne ikke verificeres. Underret venligst udvikleren om dette problem. Selvom du kan fortsætte med at installere APK\'en på eget ansvar, anbefaler vi forsigtighed på grund af mulige sikkerhedsmæssige bekymringer.';
  ...
  String get readerModeDescription =>
      'Lader dig få en forhåndsvisning af dine opgaver indeni redigeringsskærmen.';
  ...
  String get readerModeDescriptionShort =>
      'Skift starttilstand, når du åbner en opgave';
  ...
  String get syncFileLocked =>
      'Serveren har låst en backup-fil, prøv venligst igen om ca. 15 minutter.';

  @override
  String get syncInternalError =>
      'Der opstod en intern fejl, vi beklager ulejligheden.';
  ...
  String get migratingNextcloudToRemote =>
      'Migrerer Nextcloud til en ny synkroniseringsimplementering…';

  @override
  String get migratingWebdavToRemote =>
      'Migrerer WebDAV til en ny synkroniseringsimplementering…';
  ...
  String get migrateToRemotesDescription =>
      'Doable har for nylig ændret, hvordan den synkroniserer med fjernbetjeninger som Nextcloud eller Webdav. Desværre er den nye implementering ikke bagudkompatibel, og derfor skal der ske en migrering. Doable har brug for et minut til at migrere alt, hvad den skal.\n\nHvis du vælger at gøre det senere, kan du støde på nogle fejlmeddelelser, da den nye implementering endnu ikke er sat op.';

  @override
  String get fixBrokenRemoteFile =>
      'En backup-fil af Doable ser ud til at være korrupt. Doable kan løse det ved at tilsidesætte den med den aktuelle, lokale værdi. Det vil tilsidesætte alle ændringer, der er foretaget af andre enheder, efter at fejlen opstod.';
  ...
  String get syncFileDoesNotExist =>
      'En sikkerhedskopifil af Doable findes ikke.';
  ...
  String get listColorAsAccentDescription =>
      'Brug farven på den aktuelle liste som accentfarve for Doable';
  ...
  String get aboutOpenSource =>
      'Al Doables kildekode er tilgængelig på Codeberg under en FOSS-licens. Du kan også indsende problemer og pull requests der. Du kan også finde Doables F-Droid repository på Codeberg!';

  @override
  String get aboutPrivacy =>
      'Doable indsamler ingen personlige oplysninger om dig. Det eneste, Doable gemmer om din brug, er logfiler. Men disse logfiler **uploades ikke automatisk.** Den eneste måde, hvorpå disse logfiler forlader din enhed, er, hvis du vælger at dele dem, for eksempel for at hjælpe mig med at rette en fejl.';
  ...
  String get enableNotificationSoundDescription =>
      'Afspil en brugerdefineret lyd, når du viser en notifikation';
  ...
  String get hideListDescription =>
      'Vis ikke opgave på denne liste i oversigten.';
  ...
  String get updateRelease =>
      'Åbn Doables udgivelsesside, og download den nyeste version';

  @override
  String get updateDownload =>
      'Lad Doable downloade den nyeste version for dig; du finder filen i meddelelsesområdet og kan installere den ved at klikke på den';

  @override
  String get updateFdroid =>
      'Hvis du har installeret Doable fra F-Droid, bør du få opdateringen inden for de næste par timer enten fra IzzyOnDroid\'s repository eller Doable\'s eget repository';

  @override
  String get updateDisable =>
      'Du kan også slå automatisk opdateringskontrol helt fra i indstillingerne';
  ...
  String get autoExportDescription =>
      'Du kan lade Doable automatisk eksportere dine opgaver, lister og indstillinger. Vær opmærksom på, at Doable opretter en ny fil for hver eksport! Vælg varigheden mellem eksporterne i overensstemmelse hermed.';
  ...
  String get swipeActionsDescription =>
      'Tilføjer mulighed til at swipe til venstre på opgaver for enten at stjernemarkere eller færdigøre dem.\n\n**Bemærk, at dette nogle gange kan komme i konflikt med skuffen i listeudvidelsen.**';
  ...
  String get swipeActionComplete =>
      'Marker opgave som fuldført / ikke fuldført';
  ...
  String get forceHighestRefreshRateDescription =>
      '(Prøv at) tvinge systemet til at bruge den højest mulige opdateringshastighed inde i appen';
  ...
  String get expandTodosByDefaultDescription =>
      'Vis opgaver som udvidet som standard';
  ...
  String get progressBarDescription =>
      'Tilføjer en fremgangslinje til dine opgaver, så du får bedre kontrol over, om de er færdige.';

  @override
  String get syncMultipleErrors =>
      'Fjernbetjeningen stødte på flere fejl. Se logfilerne for detaljer.';
  ...
  String get dateFiltersDescription =>
      'Tilføj muligheden for at filtrere dine opgaver efter et bestemt datointerval.';
  ...
  String get enablePrideFlagsDescription =>
      'Viser Pride-flag bag titellinjen i visse måneder';
